...
const booksSlice = createSlice({
    ...
    initialState,
    extraReducers: {
        [fetchBooks.pending]: (store, _) => ({...store, loading: true, error: null}),
        ...
        [addBook.pending]: (store, _) => ({...store, loading: true, error: null}),
        ...
        [removeBook.pending]: (store, _) => ({...store, loading: true, error: null}),
